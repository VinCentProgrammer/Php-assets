            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        ?>
                        <input type="text" name="name_product" id="name" value="<?php echo set_value('name_product'); ?>">
                        ...
                        ?>
                        <input type="text" name="price_current" id="price_current" value="<?php echo set_value('price_current'); ?>">
                        <label for="desc">Mô tả ngắn</label>
                        <?php echo form_error('desc_product', 'add-user');
                        ?>
                        <textarea name="desc_product" id="desc_product" cols="30" rows="10"><?php echo set_value('desc_product'); ?></textarea>
                        ...
                        <input type="submit" value="Thêm sản phẩm" id="btn-add-product" name="btn-add-product">
                    </form>
                </div>
            </div>
        </div>
