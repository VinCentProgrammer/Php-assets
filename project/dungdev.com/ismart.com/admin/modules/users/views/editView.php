    ...
    <div class="wrap clearfix">
        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left">Cập nhật thông tin user</h3>
                </div>
            </div>
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" id="upadate_info">
                        ...
                        <?php echo form_error('tel', 'add-user') ?>
                        <input type="tel" name="tel" id="tel" value="<?php echo $info_user['phone_numbers'] ?>">
                        <label for="address">Địa chỉ</label>
                        <textarea name="address" id="address"><?php echo $info_user['address'] ?></textarea>
                        <label for="birth">Tuổi</label>
                        <input type="text" name="date-of-birth" id="date-of-birth" value="<?php echo $info_user['age'] ?>">
                        <label for="gender">Giới tính</label>
                        <select name="gender" id="gender">
                            <option value="">Chọn</option>
                            <option <?php if ($info_user['gender'] == 'male') echo "selected = 'selected'"; ?> value="male">Nam</option>
                            <option <?php if ($info_user['gender'] == 'female') echo "selected = 'selected'"; ?> value="female">Nữ</option>
                        </select>
