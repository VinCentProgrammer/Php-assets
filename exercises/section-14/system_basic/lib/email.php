...
function send_mail($send_to_email, $sen_to_fullname, $subject, $content, $option = array()){
    global $config;
    ...
    try {
        ...
        $mail -> CharSet = 'UTF8';
        //Recipients
        $mail->setFrom($config['username'], $config['fullname']);
        $mail->addAddress($send_to_email, $sen_to_fullname);     //Add a recipient
        // $mail->addAddress('ellen@example.com');               //Name is optional
        $mail->addReplyTo($config['username'], $config['fullname']);
