        ...
        ?>
            <div id="content" class="fl-right">
                ...
                foreach ($list_product_cat as $product_cat) {
                    $slug_title_product_cat = create_slug($product_cat['cat_title']);
                    $product_cat['url'] = "{$slug_title_product_cat}-{$product_cat['cat_id']}/";
                            ...
                            <div class="section-detail">
                                <ul class="list-item clearfix">
                                    ...
                                    foreach ($products as $product) {
                                        $product['url'] = create_slug_detail_product($product_cat['cat_title'], $product_cat['cat_id'], $product['product_title'], $product['id']);
                                    ?>
                                        <li>
