                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                foreach ($list_product_bought as $product) {
                                    // show_array($product);
                                    $info_cat = get_info_cat_by_cat_id($product['cat_id']);
                                    $product['url'] = create_slug_detail_product($info_cat['cat_title'], $info_cat['cat_id'], $product['title'], $product['id']);
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="clearfix">
                                            <div class="fl-right">
                                                <a href="gio-hang/thanh-toan" title="" id="checkout-cart">Thanh toán</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
