                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="qty[<?php echo $product['id']; ?>]" value="<?php echo $product['product_qty'] ?>" class="num-order" min = '1' max = '100'>
                                        </td>
                                        <td><?php echo currency_format($product['product_sub_total']); ?></td>
                                        <td>
